...
begin
  ...
  begin
    AttachToConsole;
    try
      // запросить путь к базе если не передан в параметре
      // запросить путь к бэкапу если не передан в параметре
      // запросить системные логин/пароль
