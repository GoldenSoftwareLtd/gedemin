...
const
  ...
  YAFFIL_PATH = '.\ya';
  FIREBIRD_15_PATH = '.\fb15';
  FIREBIRD_20_PATH = '.\fb20';
  FIREBIRD_21_PATH = '.\fb21';
  FIREBIRD_25_PATH = '.\fb25';
  FIREBIRD_30_PATH = '.\fb30';
...
var
  ConfigFile: TextFile;
begin
  AssignFile(ConfigFile, IncludeTrailingBackslash(GetApplicationDirectory) + FIREBIRD_CONF_FILENAME);
  Rewrite(ConfigFile);
  // Запишем новую директорию сервера
