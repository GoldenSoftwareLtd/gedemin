...
begin
  ...
  try
    ...
    try
      ...
      try
        q.SQL.Text :=
          'ALTER TABLE gd_goodgroup ADD temp_desc dblobtext80_1251 ';
        q.ExecQuery;
      except
        on E: Exception do
        begin
      ...
      try
        q.SQL.Text :=
          'UPDATE gd_goodgroup SET temp_desc = description ';
        q.ExecQuery;
      except
        on E: Exception do
        begin
      ...
      try
        q.SQL.Text :=
          'ALTER TABLE gd_goodgroup DROP description ';
        q.ExecQuery;
      except
        on E: Exception do
        begin
      ...
      try
        q.SQL.Text :=
          'ALTER TABLE gd_goodgroup ADD description dblobtext80_1251 ';
        q.ExecQuery;
      except
        on E: Exception do
        begin
      ...
      try
        q.SQL.Text :=
          'UPDATE gd_goodgroup SET  description = temp_desc';
        q.ExecQuery;
      except
        on E: Exception do
        begin
      ...
      try
        q.SQL.Text :=
          'ALTER TABLE gd_goodgroup DROP temp_desc ';
        q.ExecQuery;
      except
        on E: Exception do
        begin
