...
{$ENDIF}
  ...
  //!!!
  SYNS_AttrMarkBlock            =  'Mark block';
  SYNS_AttrErrorLine            =  'Error line';
  SYNS_AttrInvalidBreakPoit     =  'Invalid break';
  SYNS_AttrExecutionPoint       =  'Execution point';
  SYNS_AttrEnableBreakPoint     =  'EnableBreakPoint';
  //!!!
