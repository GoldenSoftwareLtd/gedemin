  ...
  try
    ...
    try
      ...
      try
        ...
        FIBSQL.SQL.Text := 'DROP TRIGGER gd_bi_people ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'DROP TRIGGER gd_bu_people ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop wtitle ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people add wtitle dtext60 ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people add wpositionkey dforeignkey ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people add personalnumber dtext40 ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop passportdate ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop visitcard2 ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop ipphone ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop wpager ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop whandy ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop woffice ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop hfax ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop defaultphone ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'alter table gd_people drop hurl ';
        try
          FIBSQL.ExecQuery;
        except
        end;
        ...
        FIBSQL.SQL.Text :=
          ...
          ' '#13#10 +
          '  CONSTRAINT wg_pk_position_id PRIMARY KEY (id) '#13#10 +
          ') ';
        try
          FIBSQL.ExecQuery;
        except
        ...
        FIBSQL.SQL.Text := 'ALTER TABLE wg_position DROP alias ';
        try
          FIBSQL.ExecQuery;
        except
        end;
        ...
        FIBSQL.SQL.Text :=
          'RECREATE TRIGGER wg_bi_position FOR wg_position '#13#10 +
          '  BEFORE INSERT '#13#10 +
          '  POSITION 0 '#13#10 +
          'AS '#13#10 +
          'BEGIN '#13#10 +
        ...
        FIBSQL.SQL.Text := 'ALTER TABLE gd_people ADD hplacekey dforeignkey ';
        try
          FIBSQL.ExecQuery;
        except
        end;

        FIBSQL.SQL.Text := 'ALTER TABLE gd_bank ADD SWIFT dtext20 ';
        try
          FIBSQL.ExecQuery;
        except
        end;
        ...
        FIBSQL.SQL.Text :=
          ...
          'BEGIN '#13#10 +
          '  NEW.rank = NULL; '#13#10 +
          '  SELECT SUBSTRING(name FROM 1 FOR 20) FROM wg_position WHERE id = NEW.wpositionkey '#13#10 +
          '    INTO NEW.rank; '#13#10 +
          ' '#13#10 +
        ...
        FIBSQL.SQL.Text := 'DROP TRIGGER gd_au_companyaccount ';
        try
          FIBSQL.ExecQuery;
        except
        end;
