...
// 'рабочий' gdcОбъект
  ...
  FFormStreamSaver := Tgdc_frmStreamSaver.CreateAndAssign(Self);
  (FFormStreamSaver as Tgdc_frmStreamSaver).SetParams(gdcSetting);

  AllGSFList := Tgdc_frmStreamSaver(FFormStreamSaver).AllGSFList;
end;
...
begin
  ...
  Tgdc_frmStreamSaver(FFormStreamSaver).ShowInstallPackageForm;
  ModalResult := mrOK;
end;
