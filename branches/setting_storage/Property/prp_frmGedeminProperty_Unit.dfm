inherited frmGedeminProperty: TfrmGedeminProperty
  ...
  object ActionList: TActionList
    ...
    object actPost: TAction
      Caption = '&Сохранить'
      Hint = 'Сохранить изменения в базу'
      OnExecute = actPostExecute
      OnUpdate = actPostUpdate
    end
    object actCancel: TAction
      Caption = '&Откат изменений'
      Hint = 'Откат изменений'
    ...
    object actFindSfById: TAction
      Category = 'Find'
      Caption = '&Поиск &функции по ID'
      Hint = 'Поиск функции по ID'
    ...
    object actEditorSet: TAction
      ...
      Hint = 'Установки редактора'
      ImageIndex = 28
      OnExecute = actEditorSetExecute
    end
    object actLoadFromFile: TAction
      Category = 'Script'
      Caption = 'Загрузить скрипт из файла...'
      Hint = 'Загрузить скрипт-объект из файла'
      ImageIndex = 27
    ...
    object actSaveToFile: TAction
      Category = 'Script'
      Caption = 'Сохранить скрипт в файл...'
      Hint = 'Сохранить скрипт-объект в файл'
      ImageIndex = 25
    ...
    object actSaveAll: TAction
      ...
      Hint = 'Сохранить все изменёные скрипты'
      OnExecute = actSaveAllExecute
      OnUpdate = actSaveAllUpdate
    end
    object actClose: TAction
      Caption = '&Закрыть'
      Hint = 'Закрыть редактируемый скрипт'
      ShortCut = 49267
      OnExecute = actCloseExecute
      OnUpdate = actCloseUpdate
    end
    object actCloseAll: TAction
      Caption = 'З&акрыть все'
      Hint = 'Закрыть все скрипты'
    ...
    object actFastReportHelp: TAction
      Category = 'Help'
      Caption = 'Справка по FastReport'
      ImageIndex = 13
      OnExecute = actFastReportHelpExecute
    end
    object actPGHelp: TAction
      Category = 'Help'
      Caption = 'Руководство програмиста'
      ImageIndex = 13
    ...
    object actFindDelEventsSF: TAction
      Category = 'Find'
      Caption = 'Поиск &неиспользуемых функций...'
      Hint = 'Поиск неиспользуемых функций...'
      ImageIndex = 24
  ...
  object actlDebug: TActionList
    ...
    object actDebugStepOver: TAction
      Category = 'Debug'
      Caption = 'Шаг &через'
      Hint = 'Выполнить без остановки в процедуре'
      ImageIndex = 13
      ShortCut = 119
    ...
    object actDebugGotoCursor: TAction
      ...
      Hint = 'Выполнять до текущего положения курсора'
      ImageIndex = 10
      ShortCut = 115
    ...
    object actToggleBreakpoint: TAction
      Category = 'Debug'
      Caption = '&Установить/снять точку останова'
      Hint = 'Установить/снять точку останова'
      ImageIndex = 5
      ShortCut = 116
    ...
    object actGotoOnExecute: TAction
      Category = 'Debug'
      Caption = 'Перейти на выполняемую с&троку'
      Hint = 'Перейти на выполняемую строку'
      ImageIndex = 11
    ...
    object actAddWatch: TAction
      Caption = 'Добавить в просмотр п&еременных'
      ShortCut = 16500
