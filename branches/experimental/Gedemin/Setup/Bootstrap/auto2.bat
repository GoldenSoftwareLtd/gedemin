...
echo **                                             **
echo **  Auto:                                      **
echo **  Использование: auto2.bat /ftp или /no_ftp  **
echo **                                             **
echo *************************************************
...
call make_install.bat "%setting_source_path%\Санаторий\GS.Санаторий.yml"                                    san       doc.jpg     sanlocal      san_setup.rar      "%install_target_path%\Санаторий\setup.exe" %send_ftp% 
goto exit
