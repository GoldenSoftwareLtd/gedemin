...
uses
  ...
  mmIBRunTimeStore,  xDBIBLookupStored,              boSecurity,
  mmIBOptions,       xnextcod,     gsGanttCalendar,  gsAbout,
  gsAboutBase;
...
begin
  ...
  RegisterComponents('x-DataBase',      [TmmIBOptions]);
  ...
  RegisterComponents('x-DataBase',      [TmmIBRunTimeStore]);
  ...
  RegisterComponents('x-DataBase',      [TboIBSecurity]);
  ...
  RegisterComponents('x-DataBase',      [TxIBLookupCombo]);
