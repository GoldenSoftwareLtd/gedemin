...
{const
  InfoMessage = 'ѕакет настроек %s зависит от %s. ѕо указанному пути и/или в базе данных обнаружено несколько ' +
' версий данного пакета настроек. ”кажите пакет, который вы хотите установить. ';}
  ...
  begin
    ...
    begin
      ...
      case VerInfo of
        ...
        svNewer: Ver := ' - нова€ верси€';   
        svEqual: Ver := ' - версии совпадают';
//        svOlder: Ver := ' - стара€ верси€';
//        svIncorrect: mGSFInfo.Lines.Add('Ќекорректна');
        svIndefinite: Ver := ' - INDEFINITE';
      else
        Ver := '';
      end;
      mGSFInfo.Lines.Add('¬ерси€: ' + IntToStr(Version) + Ver);
      mGSFInfo.Lines.Add('»зменен: ' + DateToStr(Date));
