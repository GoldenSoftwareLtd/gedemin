...
//******************************************************************************
  ...
  //Команды используемые окном Property
  ecFindInTree = 1004;
  ecAddItem = 1005;
  ecDeleteItem = 1006;
  ecAddFolder = 1007;
  ecDeleteFolder = 1008;
  ecCutTreeItem = 1009;
  ecPasteTreeItem = 1010;
  ecCopyTreeItem = 1011;
  ecRefreshTree = 1012;
  ecExecReport = 1013;
  ecDisableMethod = 1014;
  ecCommit = 1015;
  ecRollBack = 1016;
  ecLoadFromFile = 1017;
  ecSaveToFile = 1018;
  ecSQLEditor = 1019;
  //Комнды управления дебагером
  ecPrepare = 1049;
  ecEvaluate = 1050;
  ecDebugRun = 1051;
  ecDebugStepIn = 1052;
  ecDebugStepOut = 1053;
  ecDebugGotoCursor = 1054;
  ecDebugPause = 1055;
  ecProgramReset = 1056;
  ecToggleBreakPoint = 1057;
  ecAddWatch = 1058;
  //Переход на включаемую функцию
  ecGotoToInclude = 1100;
  //!!!
...
const
  EditorCommandStrs: array[0..131] of TIdentMapEntry = (
    ...
    //!!!
    (Value: ecSelMoveRight; Name:'ecSelMoveRight'),
    (Value: ecSelMoveLeft; Name:'ecSelMoveLeft'),
    (Value: ecCodeComplite; Name:'ecCodeComplite'),
    (Value: ecFind; Name:'ecFind'),
    (Value: ecFindNext; Name:'ecFindNext'),
    (Value: ecReplace; Name:'ecReplace'),
    (Value: ecFindInTree; Name:'ecFindInTree'),
    (Value: ecAddItem; Name:'ecAddItem'),
    (Value: ecDeleteItem; Name:'ecDeleteItem'),
    (Value: ecAddFolder; Name:'ecAddFolder'),
    (Value: ecDeleteFolder; Name:'ecDeleteFolder'),
    (Value: ecCutTreeItem; Name:'ecCutTreeItem'),
    (Value: ecPasteTreeItem; Name:'ecPasteTreeItem'),
    (Value: ecCopyTreeItem; Name:'ecCopyTreeItem'),
    (Value: ecRefreshTree; Name:'ecRefreshTree'),
    (Value: ecExecReport; Name:'ecExecReport'),
    (Value: ecDisableMethod; Name:'ecDisableMethod'),
    (Value: ecCommit; Name:'ecCommit'),
    (Value: ecRollback; Name:'ecRollback'),
    (Value: ecLoadFromFile; Name:'ecLoadFromFile'),
    (Value: ecSaveToFile; Name:'ecSaveToFile'),
    (Value: ecSQLEditor; Name:'ecSQLEditor'),
    (Value: ecEvaluate; Name:'ecEvaluate'),
    (Value: ecDebugRun; Name:'ecDebugRun'),
    (Value: ecDebugStepIn; Name:'ecDebugstepIn'),
    (Value: ecDebugStepOut; Name:'ecDebugStepOut'),
    (Value: ecDebugGotoCursor; Name:'ecDebugGotoCursor'),
    (Value: ecDebugPause; Name:'ecDebugPause'),
    (Value: ecProgramReset; Name:'ecProgramReset'),
    (Value: ecToggleBreakPoint; Name:'ecToggleBreakPoint'),
    (Value: ecPrepare; Name:'ecPrepare'),
    (Value: ecAddWatch; Name:'ecAddWatch'),
    (Value: ecGotoToInclude; Name:'ecGotoToInclude'),
    (Value: ecComentBlock; Name:'ecComentBlock'),
    (Value: ecUnComentBlock; Name:'ecUnComentBlock'),
    (Value: ecCodeTemplate; Name:'ecCodeTemplate')
    );
    //!!!
