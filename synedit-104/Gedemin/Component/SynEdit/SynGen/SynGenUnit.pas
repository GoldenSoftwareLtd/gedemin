...
$Id: SynGenUnit.pas,v 1.11 2001/10/24 09:40:26 plpolak Exp $
...
begin
  ...
  Writeln(OutFile, '{$IFDEF SYN_KYLIX}');
...
begin
  ...
  begin
    ...
    begin
      ...
      if (IdentList[I] = IdentPre + 'Key') then
        Writeln(OutFile, '  ' + AttrTemp + '.Style := [fsBold];');
      if (IdentList[I] = IdentPre + 'Comment') then
      begin
