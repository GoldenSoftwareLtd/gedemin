...
Здесь пара моментов:
  ...
  (например нам вздумалось вывести один и тот же документ в разных папках исследователя).
  При сохранении их в настройку они сольются в одну }
...
begin
  ...
  begin
    MessageBox(ParentHandle,
      'Изменение прав доступа на класс не распространяется на уже существующие записи в базе.',
      'Внимание',
