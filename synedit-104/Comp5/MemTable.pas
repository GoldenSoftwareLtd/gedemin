...
procedure TMemTable.EncodeFieldDesc(var FieldDesc: FLDDesc;
  const Name: string; DataType: TFieldType; Size: Word);
begin
  with FieldDesc do
  begin
...
procedure TMemTable.DestroyHandle;
begin
  inherited DestroyHandle;
  Check(dbiCloseDatabase(hNilDB));
end;

procedure TMemTable.BorrowFields(const Value: TTable);
var
  I: Integer;
begin
  Active := False;
...
procedure Register;
begin
  RegisterComponents('x-DataBase', [TMemTable]);
end;
