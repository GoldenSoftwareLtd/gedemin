...
//!!!b
procedure TApdDataPacketManager.SetComPort(const Value: TApdCustomComPort);
begin
  if Value <> nil then
    raise Exception.Create('Changing of comport is not allowed here.');
  if fComPort <> nil then
    FComPort.DeregisterUserCallbackEx(PortOpenCloseEx);
  fComPort := Value;
end;
//!!!e
