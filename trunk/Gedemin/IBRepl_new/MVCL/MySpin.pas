...
type
  ...
  {!!!}
  TTimerSpeedButtonClass = class of TTimerSpeedButton;
  TSpinButtonClass = class of TSpinButton;
  {!!!}
{ TSpinButton }
  ...
  protected
    ...
    {!!!}
    function GetTimerSpeedButton: TTimerSpeedButtonClass; virtual;
    {!!!}
  public
...
{ TSpinEdit }
  ...
  protected
    ...
    {!!!}
    function GetSpinButtonClass: TSpinButtonClass; virtual;
    {!!!}
  public
    constructor Create(AOwner: TComponent); override;
...
//  Result := TTimerSpeedButton.Create(Self);
  Result := GetTimerSpeedButton.Create(Self);
  {!!!}
...
function TSpinButton.GetTimerSpeedButton: TTimerSpeedButtonClass;
begin
  Result := TTimerSpeedButton;
end;
...
//  FButton := TSpinButton.Create(Self);
  FButton := GetSpinButtonClass.Create(Self);
  {!!!}
  FButton.Width := 15;
  FButton.Height := 17;
...
procedure TMySpinEdit.GetChildren(Proc: TGetChildProc; Root: TComponent);
begin
end;

procedure TMySpinEdit.KeyDown(var Key: Word; Shift: TShiftState);
begin
...
procedure TMySpinEdit.CreateWnd;
begin
  inherited CreateWnd;
  SetEditRect;
end;

procedure TMySpinEdit.SetEditRect;
var
  Loc: TRect;
begin
...
procedure TMySpinEdit.WMSize(var Message: TWMSize);
var
  MinHeight: Integer;
begin
  inherited;
...
function TMySpinEdit.GetMinHeight: Integer;
var
  DC: HDC;
  SaveFont: HFont;
  I: Integer;
...
procedure TMySpinEdit.UpClick (Sender: TObject);
begin
  if ReadOnly then MessageBeep(0)
  else Value := Value + FIncrement;
end;

procedure TMySpinEdit.DownClick (Sender: TObject);
begin
  if ReadOnly then MessageBeep(0)
  else Value := Value - FIncrement;
end;

procedure TMySpinEdit.WMPaste(var Message: TWMPaste);
begin
  if not FEditorEnabled or ReadOnly then Exit;
  inherited;
end;

procedure TMySpinEdit.WMCut(var Message: TWMPaste);
begin
  if not FEditorEnabled or ReadOnly then Exit;
  inherited;
end;

procedure TMySpinEdit.CMExit(var Message: TCMExit);
begin
  inherited;
...
function TMySpinEdit.GetValue: LongInt;
begin
  try
...
procedure TMySpinEdit.SetValue (NewValue: LongInt);
begin
  Text := IntToStr (CheckValue (NewValue));
end;

function TMySpinEdit.CheckValue (NewValue: LongInt): LongInt;
begin
  Result := NewValue;
...
procedure TMySpinEdit.CMEnter(var Message: TCMGotFocus);
begin
...
function TMySpinEdit.GetSpinButtonClass: TSpinButtonClass;
begin
  Result := TSpinButton;
end;
