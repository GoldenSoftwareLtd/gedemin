...
rem call make_install.bat "%setting_source_path%\Общие\Комплексная_автоматизация.gsf"                           business  complex.jpg businesslocal compl_setup.rar "%install_target_path%\Комплексная автоматизация\setup.exe" %send_ftp%
rem call make_install.bat "%setting_source_path%\Предприниматель\Подоходный\Предприниматель_подоходный.gsf"     ip        ip.jpg      iplocal       ip_setup.rar    "%install_target_path%\Предприниматель\setup.exe" %send_ftp%
rem call make_install.bat "%setting_source_path%\Предприниматель\Единый налог\Предприниматель_единый_налог.gsf" ip        ip.jpg      iplocal       ip_setup_ed.rar "%install_target_path%\Предприниматель\setup_ed.exe" %send_ftp%
rem call make_install.bat "%setting_source_path%\Общие\Общие данные.gsf"                                        devel     complex.jpg devellocal    devel_setup.rar "%install_target_path%\Разработчик\setup.exe"         %send_ftp%
...
rem call make_install.bat "%setting_source_path%\Меню\2011 Бэк-офис\2011 Менюback.gsf"                          menuback     complex.jpg menubacklocal    menuback_setup.rar "%install_target_path%\Меню\setup_back.exe" %send_ftp%
rem call make_install.bat "%setting_source_path%\Меню\2011 Фронт-офис\2011  Menu front.gsf"                     menufront    complex.jpg menufrontlocal   menufront_setup.rar "%install_target_path%\Меню\setup_front.exe" %send_ftp%
