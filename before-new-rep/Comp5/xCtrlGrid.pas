...
uses
  ...
  Grids, DBGrids, ExList, DB, mmDBGrid;
...
procedure TxCtrlGrid.WMChar(var Message: TWMChar);
var
  CurrCtrl: TCtrl;
begin
...
procedure TxCtrlGrid.CMExit(var Message: TMessage);
begin
...
function TxCtrlGrid.GetCurrControl: TObject;
var
  I: Integer;
begin
  Result := nil;
...
procedure TxCtrlGrid.DoOnCtrlExit(Sender: TObject);
var
  CurrCtrl: TCtrl;
begin
...
procedure TxCtrlGrid.DoOnCtrlKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  CurrCtrl: TCtrl;
  D: TDataLink;
...
function TxCtrlGrid.GetCurrCtrl: TWinControl;
begin
...
procedure TxCtrlGrid.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  R: TGridCoord;
...
procedure TxCtrlGrid.Notification(AComponent: TComponent; Operation: TOperation);
var
  SearchCtrl: TObject;
...
constructor TxCtrlGrid.Create(AnOwner: TComponent);
begin
...
procedure TxCtrlGrid.ShowCtrl(Ctrl: TWinControl);
var
  R: TRect;
  Show: Boolean;
begin
...
procedure TxCtrlGrid.AddControl(AFieldName: String; AControl: TWinControl;
  var ControlOnExit: TNotifyEvent; var ControlOnKeyDown: TKeyEvent);
var
  ACtrl: TCtrl;
begin
...
procedure TxCtrlGrid.DeleteControl(AFieldName: String;
  var ControlOnExit: TNotifyEvent; var ControlOnKeyDown: TKeyEvent);
var
  I: Integer;
begin
