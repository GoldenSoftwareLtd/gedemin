...
const
  Exceptions: array[1..9] of TmdfException = (
    (ExceptionName: 'INV_E_CANNTCHANGEFEATURE'; Message: 'Нельзя изменять признаки, т.к. они влияют на дальнейшее движение'),
    (ExceptionName: 'INV_E_CANNTCHANGEGOODKEY'; Message: 'Нельзя изменять товар в позиции, т.к. по позиции было дальнейшее движение!'),
    (ExceptionName: 'INV_E_DONTCHANGEBENEFICIARY'; Message: 'Нельзя изменить получателя'),
    (ExceptionName: 'INV_E_DONTCHANGESOURCE'; Message: 'Нельзя изменить источник!'),
    (ExceptionName: 'INV_E_DONTREDUCEAMOUNT'; Message: 'Нельзя уменьшить количество по позиции'),
    (ExceptionName: 'INV_E_EARLIERMOVEMENT'; Message: 'Нельзя изменить дату, т.к. было более раннее движение товара!'),
    (ExceptionName: 'INV_E_INCORRECTQUANTITY'; Message: 'Количество по документу не соответсвует созданному движению!'),
    (ExceptionName: 'INV_E_INSUFFICIENTBALANCE'; Message: 'Недостаточно остатков на указанную дату'),
    (ExceptionName: 'INV_E_NOPRODUCT'; Message: 'На указанную дату нет остатка товара!'));
