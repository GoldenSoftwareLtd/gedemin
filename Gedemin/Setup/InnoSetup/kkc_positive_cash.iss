...
#define CashName "POSitive: Cash"

[Setup]
AppName={#CashName}
AppVerName={#CashName}
AppID=POSitiveCash25
AppPublisher=KKC, Ltd
AppPublisherURL={#URL}
AppSupportURL={#URL}
AppUpdatesURL={#URL}
AppSupportPhone=+375-17-32-111-32
DefaultDirName={sd}\KKC\POSitive Cash
...
Filename: "{app}\gedemin.ini"; Section: "WEB CLIENT"; Key: "Token"; String: "POSITIVE_CASH"; 
