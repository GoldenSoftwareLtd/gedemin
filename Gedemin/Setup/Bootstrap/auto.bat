...
rem call make_install.bat "%setting_source_path%\Меню\Бэк-офис\Меню_БэкОфис.gsf"                                menuback     complex.jpg menubacklocal    menuback_setup.rar "%install_target_path%\Меню\setup_back.exe" %send_ftp%
rem call make_install.bat "%setting_source_path%\Меню\Фронт-офис\00 Меню  Фронтофис.gsf"                        menufront    complex.jpg menufrontlocal   menufront_setup.rar "%install_target_path%\Меню\setup_front.exe" %send_ftp%
