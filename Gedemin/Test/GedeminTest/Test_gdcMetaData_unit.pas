...
type
  ...
  TgdcInheritedTableTest = class(TgdcTableToTableTest)
  protected
    function GetTableClass: CgdcTable; override;
  end;
...
function TgdcInheritedTableTest.GetTableClass;
begin
  Result := TgdcInheritedTable;
end;
...
initialization
  ...
  RegisterTest('DB\TgdcMetaDataTest\StandartTables', TgdcInheritedTableTest.Suite);
