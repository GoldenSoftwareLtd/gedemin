object frmSQLEditorSyn: TfrmSQLEditorSyn
    ...
    object pcMain: TSuperPageControl
      ...
      object tsRelations: TSuperTabSheet
        ...
        object Panel2: TPanel
          ...
          object edRelationsFilter: TEdit
            Left = 85
            Top = 3
            Width = 160
            Height = 21
            TabOrder = 1
            OnChange = edRelationsFilterChange
          end
        end
  ...
  object ActionList: TActionList
    ...
    object actRelationsRefresh: TAction
      Caption = 'actRelationsRefresh'
      OnExecute = actRelationsRefreshExecute
    end
    object actSaveClassesToFile: TAction
      Category = 'Classes'
      Caption = 'Save to file...'
      ImageIndex = 202
      OnExecute = actSaveClassesToFileExecute
    end
  end
  ...
  object sdClassFile: TSaveDialog
    DefaultExt = 'json'
