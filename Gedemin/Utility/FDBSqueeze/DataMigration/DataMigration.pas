...
type
  ...
  //  DatabaseBackupName: String;
    ...
    ActivTriggersList: TStringList    // список всех активных триггеров
    ActivIndicesList: TStringList     // список всех активных индексов

    //ограничения, все значений располагаются во всех списках соответственно
...
//=========================================== РАЗБИТЬ НА ПРОЦЕДУРЫ! временный код
   //================================ ТРИГГЕРЫ
...
// triggersSwitch(1, ActivTriggersList, IBSQLWrite);  //отключим триггеры
...
// indicesSwitch(1, ActivIndicesList, IBSQLWrite)  //отключим индексы
...
begin
  ...
  // обработка шапок
   ...
   ///ListPkFk - список 
   ///X - список id записей от которых мы первоначально хотели избавиться
   ///list - список главных таблиц
  ...
  //перенос таблиц 1-к-1 (detail)
  //======================================[temp] private procedure 1to1_migration(TStringList list)  1-to-1 для !!!!
  ...
  //=================================[temp] private procedure перенос таблицы-связки_migration (TIntList CrossList, TIntList masterPK)  //список РК связок и список РК мастер содержащии множество
