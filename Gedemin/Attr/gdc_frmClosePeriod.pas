...
begin
  ...
  begin
    ...
    InnerFormVariable.btnRun.Caption := 'ѕрервать выполнение';
  end;
end;
...
begin
  ...
  begin
    ...
    InnerFormVariable.btnRun.Caption := '¬ыполнить закрытие периода';
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        // ≈сли у на есть список выбранных, то будем ориентироватьс€ на него, иначе заполн€ем выбранные признаки
