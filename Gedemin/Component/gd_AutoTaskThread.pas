...
begin
  ...
  case Msg.Message of
    ...
    begin
      ...
      gdNotifierThread.Add('Планировщик заданий: запущен')
    end;
    ...
    begin
      ...
      if FTask = nil then
      begin
        gdNotifierThread.Add('Планировщик заданий: нет активных задач');
        ExitThread;
        gdNotifierThread.Add('Планировщик заданий: остановлен');
      end
      else
      begin
        SetTimeout(1);
    ...
    WM_GD_EXEC:
    begin
      gdNotifierThread.Add('Планировщик заданий: выполнение ' + FTask.Name);
