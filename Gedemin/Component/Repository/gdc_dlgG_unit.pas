    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if RF <> nil then
          begin
            if (RF.Description > '') and (TFieldDataLink(L).Control is TWinControl)
              and (RF.Description <> RF.FieldName) then
            begin
          ...
          begin
            ...
            begin
              ...
              MessageBox(gdcObject.ParentHandle, PChar(
                'Пользователь ' + GetUserByTransaction(StatusVectorArray[9]) +
                  ' открыл данную запись.'#13#10#13#10 +
                'Вы можете только просматривать данные.'),
            ...
            begin
              ...
              MessageBox(gdcObject.ParentHandle,
                ...
                'Вы можете только просматривать данные.'#13#10#13#10 +
