inherited gdc_frmMDH: Tgdc_frmMDH
  ...
  inherited alMain: TActionList
    ...
    object actCopyDetailIDToClipboard: TAction
      Category = 'Detail'
      Caption = 'Скопировать ID записи в буфер'
      OnExecute = actCopyDetailIDToClipboardExecute
      OnUpdate = actDetailEditUpdate
    end
  end
  ...
  object pmDetail: TPopupMenu [12]
    ...
    object nCopyDetailIDToClipboard: TMenuItem
      Action = actCopyDetailIDToClipboard
    end
