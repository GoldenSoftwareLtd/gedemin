...
type
  ...
  private
    ...
    FTransaction: TIBTransaction;
    //Транзакция для отключения и подключения триггеров
    ...
    //Отключает все активные триггеры
    function InActiveTrigers: Boolean;
    //Включает все триггеры отключ. функцией InActiveTrigers
...
begin
  ...
  приведёт к увеличению файла репликации.
   Возможно имеет смысл чтобы такие вещи отслеживал триггер изменения
