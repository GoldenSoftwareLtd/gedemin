...
var
  I: Integer;
  lBlockBegin, lBlockEnd: TBufferCoord;
...
begin
  ...
  begin
    ...
    if lBlockEnd.Char = 1 then
      Dec(lBlockEnd.Line);

    for I := lBlockBegin.Line - 1 to lBlockEnd.Line - 1 do
    ...
    begin
      lBlockEnd.Char := lBlockEnd.Char - 2;
      if lBlockEnd.Char < 1 then
        lBlockEnd.Char := 1;
    end;

    if lBlockBegin.Char > 1 then
      lBlockBegin.Char := lBlockBegin.Char - 2;
