...
type
  ...
  private
    ...
    //!!!
    fMarkBlockAttri: TSynHighlighterAttributes;
    fErrorLineAttri: TSynHighlighterAttributes;
    fInvalidBreakPointAttri: TSynHighlighterAttributes;
    fExecutionPointAttri: TSynHighlighterAttributes;
    fEnableBreakPointAttri: TSynHighlighterAttributes;
    //!!!
  ...
  published
    ...
    property SymbolAttri: TSynHighlighterAttributes read fSymbolAttri
      write fSymbolAttri;
    //!!!
    property MarkBlockAttri: TSynHighlighterAttributes read fMarkBlockAttri
      write fMarkBlockAttri;
    property ErrorLineAttri: TSynHighlighterAttributes read fErrorLineAttri
      write FErrorLineAttri;
    property InvalidBreakPointAttri: TSynHighlighterAttributes read
      fInvalidBreakPointAttri write fInvalidBreakPointAttri;
    property ExecutionPointAttri: TSynHighlighterAttributes read fExecutionPointAttri
      write fExecutionPointAttri;
    property EnableBreakPointAttri: TSynHighlighterAttributes read fEnableBreakPointAttri
      write fEnableBreakPointAttri;
    //!!!
  end;
...
begin
  ...
  //!!!
  fMarkBlockAttri := TSynHighlighterAttributes.Create(SYNS_AttrMarkBlock);
  fMarkBlockAttri.Foreground := clHighlightText;
  fMarkBlockAttri.Background := clHighlight;
  AddAttribute(fMarkBlockAttri);
  fErrorLineAttri := TSynHighlighterAttributes.Create(SYNS_AttrErrorLine);
  fErrorLineAttri.Foreground := clWhite;
  fErrorLineAttri.Background := clMaroon;
  AddAttribute(fErrorLineAttri);
  fInvalidBreakPointAttri := TSynHighlighterAttributes.Create(SYNS_AttrInvalidBreakPoit);
  fInvalidBreakPointAttri.Foreground := clLime;
  fInvalidBreakPointAttri.Background := clOlive;
  AddAttribute(fInvalidBreakPointAttri);
  fExecutionPointAttri := TSynHighlighterAttributes.Create(SYNS_AttrExecutionPoint);
  fExecutionPointAttri.Foreground := clWhite;
  fExecutionPointAttri.Background := clBlue;
  AddAttribute(fExecutionPointAttri);
  fEnableBreakPointAttri := TSynHighlighterAttributes.Create(SYNS_AttrEnableBreakPoint);
  fEnableBreakPointAttri.Foreground := clWhite;
  fEnableBreakPointAttri.Background := clRed;
  AddAttribute(fEnableBreakPointAttri);
  //!!!
...
begin
  case Index of
    ...
    //!!!
    SYN_ATTR_MARK_BLOCK: Result := fMarkBlockAttri;
    SYN_ATTR_ERROR_LINE: Result := fErrorLineAttri;
    SYN_ATTR_INVALID_BREAK_POINT: Result := fInvalidBreakPointAttri;
    SYN_ATTR_EXECUTION_POINT: Result := ExecutionPointAttri;
    SYN_ATTR_ENABLE_BREAK_POINT: Result := EnableBreakPointAttri;
    //!!!
  else
    Result := nil;
  end;
