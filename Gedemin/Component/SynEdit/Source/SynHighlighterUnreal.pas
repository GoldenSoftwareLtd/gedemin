...
$Id: SynHighlighterUnreal.pas,v 1.4 2001/10/24 09:39:25 plpolak Exp $
...
type
  ...
  TRangeState = (rsANil, rsAnsiC, rsAnsiCAsm, rsAnsiCAsmBlock, rsAsm, rsAsmBlock,
                 rsDirective, rsDirectiveComment, rsUnKnown);                   //mh 1999-12-05
      ...
      '*':
        ...
        begin
          ...
          if fRange = rsAnsiCAsm then
            ...
            fRange := rsAsmBlock
          else if fRange = rsDirectiveComment then                              //mh 1999-12-05
            fRange := rsDirective
          else
            fRange := rsUnKnown;
          break;
