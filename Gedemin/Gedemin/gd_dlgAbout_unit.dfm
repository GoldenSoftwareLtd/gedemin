      ...
      object mCredits: TMemo
        ...
        Lines.Strings = (
          ...
          'Компания Golden Software, Ltd:'
            ...
            ' Алексей Якубель, Анастасия Благодова,'
          
            'Юрий Ломашко, Андрей Андилевко, Михаил Васильев, Кристина Попенк' +
            'о, Ольга Хозянин, Константин Кустов,'
          
            'Татьяна Шляхтич, Андрей Зезюлин, Анастасия Гладкая, Ольга Никифо' +
            'рович, Павел Якута, Роман Месник,'
          'Антон Шваб.'
          ''
          'Отдельное спасибо:'
