...
resourcestring
  ...
  s_InvErrorEditDocument =
    'В результате редактирования возникла ошибка %s, произведен откат изменений';
  s_InvErrorSaveMovement =    
    'При формировании движения возникла критическая ошибка. Произведен откат всех изменений.';
  s_InvFullErrorSaveMovement =
    'При формировании движения возникла неотвратимая ошибка: %s. Произведен откат всех изменений.';
  s_InvErrorChooseRemains = 'Нельзя выбрать больше ТМЦ, чем имеется.';
